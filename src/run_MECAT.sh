...
if [ -s ${directory}/${prefix}.contigs.fasta ] ; then
    cat ${directory}/${prefix}.contigs.fasta > ../contigs/${prefix}.contigs.fasta
    rm *.unassembled.fasta
else
    cat ${directory}/${prefix}.unassembled.fasta > ../contigs/${prefix}.unassembled.fasta
fi
